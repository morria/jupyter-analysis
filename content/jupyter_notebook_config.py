...
#  Default: ''
c.NotebookApp.custom_display_url = 'http://nuc.local/'
...
#  Choices: any of ['sha384', 'md5', 'blake2s', 'sha3_512', 'sha3_256', 'sha3_384', 'sha3_224', 'sha1', 'blake2b', 'sha512', 'sha256', 'sha224']
#  Default: 'sha256'
